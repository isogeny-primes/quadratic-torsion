...
//positive_rank := [ -79, -74, -47, -41, -26, -15, 1, 10, 15, 41, 51, 70, 79, 93, 94 ];
...
// Here is the numerator of the j-map that we need
h(Numerator(jC));
...
// Here is the denominator of the j-map that we need
h(Denominator(jC));
...
// Here is the b of the abc triple
b := c - a;
...
for d in positive_rank do
  ...
  if #points gt 2 then
    print "====", d, #points, "====";
    print points;
    js := {j1728_from_point(point) : point in points | point[1] ne 0 and
                                                      point[3] ne 0 and
                                                      point[1]/point[3] ne 1 and
                                                      point[1]/point[3] ne -1};
    print js;
    abc := {abc_from_point(point) : point in points | point[1] ne 0 and
                                                      point[3] ne 0 and
                                                      point[1]/point[3] ne 1 and
                                                      point[1]/point[3] ne -1};
...
print([[[[d]],info]: d -> info in extra_point_abcs]);
