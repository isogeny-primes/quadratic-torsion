...
toPrint := d cat "," cat RealToString(height) cat "," cat Sprint(flag1) cat "," cat Sprint(flag2) cat "," cat xStr cat "," cat yStr cat "," cat zStr cat "\n";
fprintf OutputFileName, toPrint;
quit;